...
<html lang="en">
  ...
  <body>
		...
		<div class="jumbotron">
				<div class="container">
				<h2 id="cab2">Modificar Cliente</h2> 
				</div>
		</div>
		...
		<div class="container-fluid">
			<div class="panel panel-primary" >
						...
						<div class="panel-footer" id="panelFooter">
							...
							<button type="submit" class="btn btn-primary" name="formRClient" value="Sign in" style="float: right"><strong>Guardar cambios</strong></button>
						</div>
						</form>
			</div>
		</div>
