							...
							<?php 
								...
								if($tipo == 1){
									...
									foreach((array)$trabajos as $trabajo){
										...
										echo '<div class="form-group"><h4><a href = "./infoTrabajo.php?id='.$trabajo['Id'].'&cliente='.$trabajo['IdCliente'].'"><div class="container-fluid" style="width:100%; word-wrap: break-word;"><img id="margenIm" src="./includes/css/trabajo.png">'.$descripcion.'<strong></div><div id="derecha">'.$feN.'</div></strong></a></h4></div><hr id="lineas">';
									}
								} else if($tipo == 4){
